...
# now we compare the two vecors holding T/F values using the == operator
# this operator also returns a Boolean variable
...
my_data$check <- ifelse(my_data$y > 2.5, 1, 0)
